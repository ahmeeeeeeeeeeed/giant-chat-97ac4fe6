...
function extractTargetName(text: string): string | null {
  let t = ` ${text.trim()} `;
  const stripWords = ["احظر", "حظر", "فك حظر", "فك", "اطرد", "طرد", "اكتم", "كتم", "افتح", "ارفع", "رفع", "أنزل", "انزل", "انزّل", "نزل", "امنح", "منح", "اسحب", "سحب", "رتبه", "رتبة", "مشرف", "أونر", "اونر", "مالك", "المالك", "هذا", "هذه", "الحساب", "حساب", "المستخدم", "مستخدم", "من", "عن", "الى", "إلى", "البوت", "بوت"];
