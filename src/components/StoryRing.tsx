...
export function StoryRing({
  ...
  return (
    <button
      ...
      className={`relative inline-flex items-center justify-center rounded-full ${pad} bg-[conic-gradient(from_0deg,#f59e0b,#ef4444,#ec4899,#8b5cf6,#3b82f6,#10b981,#f59e0b)] shadow-[0_0_10px_-2px_rgba(236,72,153,0.6)]`}
